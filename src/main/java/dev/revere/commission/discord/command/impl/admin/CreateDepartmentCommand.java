...
public class CreateDepartmentCommand extends SlashCommand {
    ...
    protected void execute(SlashCommandEvent p_slashCommandEvent) {
        ...
        m_departmentService.createDepartmentInGuild(departmentName, guild.getJDA().getShardManager());
        p_slashCommandEvent.reply(TonicEmbedBuilder.sharedMessageEmbed("Department `" + departmentName + "` created successfully.")).queue();
    }
}
